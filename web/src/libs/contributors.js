...
// export function renderDataSet(data: GithubStats): ChartData {
//   return {
//     datasets: data.map(parseContributorDataset),
//   };
// }

// export default { renderDataSet, parseContributorDatasets };
